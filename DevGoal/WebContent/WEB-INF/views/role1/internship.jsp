					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="col col-md-6 col-lg-5">
								<label for="comment">บริษัท</label> <input class="form-control"
									id="overseaName" type="text" disabled></input>
							</div>
							<div class="row">
								<div class="col col-sm-12 col-md-3 col-lg-3">
									<label for="comment">อีเมล</label> <input class="form-control"
										id="overseaEmail" type="text" disabled></input>
								</div>
								<div class="col col-sm-12 col-md-3 col-lg-3">
									<label for="comment">เบอร์โทรศัพทร์</label> <input
										class="form-control" id="overseaPhone" type="text" disabled></input>
								</div>
								<div class="col col-sm-12 col-md-3 col-lg-3">
									<label for="comment">สถานที่ตั้ง</label> <input
										class="form-control" id="overseaType" type="text" disabled></input>
								</div>
							</div>

							<div class="col col-sm-12 col-md-6 col-lg-6">
								<label for="comment">ที่อยู่</label>
								<textarea class="form-control" rows="5" id="overseaAddress"
									name="text" disabled></textarea>
							</div>
							<div class="col col-sm-12 col-md-1 col-lg-1">
								<label for="comment">จำนวนที่รับ</label> <input
									class="form-control" id="overseaRecive" type="text" disabled></input>
								<input type="hidden" id="overseaId"> <input
									type="hidden" id="userOverseaId"> <input type="hidden"
									id="overseaMap">
							</div>
							<hr>
							<div class="row">
							...
							<div class="modal-footer">
								<button type="button" id="send" onClick="sendData()"
									class="btn btn-primary">ส่งข้อมูลส่วนตัวให้บริษัท</button>
								<button type="button" onClick="showMap()"
									class="btn btn-success">ดูแผนที่</button>
...
$('#insertYear').change(function() {
	...
	function sendData() {
		...
		const data = $.getJSON('https://api.ipify.org?format=json', function(data){
			...
			if(internship_id != '' && ip != '' && year != '' && year != '0' && term != '' && term != '0') {
					
				axios({
					  method: "post",
					  url: "sendDataToInternship",
					  data: 'internship_id=' + internship_id +'&ip=' + ip+"&year="+year+"&term="+term,
					}).then(function (response) {

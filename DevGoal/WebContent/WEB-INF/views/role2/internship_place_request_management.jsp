...
<head>
<meta charset="utf-8">
<title>ข้อมูลสถานที่ฝึกงานที่นิสิต/นักศึกษาร้องขอ</title>
		...
		<section class="p-4 my-container">
			...
			<div class="table-container table-responsive">
				<div class="row abovetable ">
					<h4>ข้อมูลสถานที่ฝึกงานที่นิสิต/นักศึกษาร้องขอ</h4>
				</div>
						...
						<div class="modal-body">
								...
								<div class="col-lg-12">
									<form>
											...
											<div class="col-sm-12 col-md-6 col-lg-4">
												<div class="form-floating ">
													<input type="text" class="form-control"
														...
														name="internshipNameModal" disabled> <label for="name">ชื่อสถานที่ฝึกงาน</label>
												</div>
											</div>
											<div class="col-sm-12 col-md-6 col-lg-3">
												<div class="form-floating ">
													<input type="text" class="form-control"
														...
														name="internshipEmailModal" disabled> <label for="initial">อีเมล</label>
												</div>
											</div>
											<div class="col-sm-12 col-md-6 col-lg-3">
												<div class="form-floating ">
										...
										<div class="row">
											...
											<div class="col-sm-12 col-md-6 col-lg-3">
												<select class="form-select" id="internshipTypeModal" disabled>
										...
										<div class="row">
											...
											<div class="col-sm-12 col-md-6 col-lg-3">
												<div class="form-floating ">
													<input type="text" class="form-control"
														id="userUniversityModal" placeholder="มหาวิทยาลัย"
														name="userUniversityModal" disabled> <label
														for="zipcode">มหาวิทยาลัย</label>
												</div>
											</div>
											<div class="col-sm-12 col-md-6 col-lg-3">
												<div class="form-floating ">
													<input type="text" class="form-control"
														id="userFacultyModal" placeholder="คณะ"
														name="userFacultyModal" disabled> <label
											...
											<div class="col-sm-12 col-md-6 col-lg-3">
												<div class="form-floating ">
													<input type="text" class="form-control"
														id="userCourseModal" placeholder="หลักสูตร"
														name="userFacultyModal" disabled> <label
														for="zipcode">หลักสูตร</label>
												</div>
											</div>
										</div>
							...
							<div class="modal-footer">
								<button type="button" class="btn btn-danger"
									data-bs-dismiss="modal" id="close_update_internship">ปิด</button>
							</div>
...
$(function() {
	axios({
		  method: "post",
		  url: "findPlaceOfInternshipRequest",
...
function ShowInternshipModal(name, email, phone, receive, type, status, time_reg, user_name, internship_id, address1, address2, address3, address4, adress5, university_name, faculty_name, course_name) {
	...
	document.getElementById('userUniversityModal').value = university_name
	document.getElementById('userFacultyModal').value = faculty_name
	document.getElementById('userCourseModal').value = course_name
...
function manegementStatus(internship_id, status) {
	...
	const data = $.getJSON('https://api.ipify.org?format=json', function(data){
		...
		if(internship_id != '') {
			...
			axios({
				  method: "post",
				  url: "managementInternshipStatus",

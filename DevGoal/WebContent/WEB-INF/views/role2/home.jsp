...
$(function() {
	...
	axios({
		  method: "post",
		  url: "getStudentCountInternshiping",
		}).then(function (response) {
			
			var xValues = []
			var yValues = []
			var barColors = [ "#009BFF", "#FF0000", "#FFDC00", "#00FFBD", "#FF0087", "#8F00FF", "#00FF0C", "F3FF00", "#FFDC00", "#00FFBD", "#FF0087", "#009BFF", "#009BFF", "#FF0000", "#FFDC00", "#00FFBD", "#FF0087", "#8F00FF", "#00FF0C", "F3FF00", "#FFDC00", "#00FFBD", "#FF0087", "#009BFF", "#009BFF", "#FF0000", "#FFDC00", "#00FFBD", "#FF0087", "#8F00FF", "#00FF0C", "F3FF00", "#FFDC00", "#00FFBD", "#FF0087", "#009BFF", "#009BFF", "#FF0000", "#FFDC00", "#00FFBD", "#FF0087", "#8F00FF", "#00FF0C", "F3FF00", "#FFDC00", "#00FFBD", "#FF0087", "#009BFF" ]
			...
			new Chart(chartEl, {
				...
				options: {
					...
					title: {
						display: true,
						text: "จำนวนนิสิต/นักศึกษาที่เข้าฝึกงานในแต่ละบริษัทของคุณ"
					}
				}
			});

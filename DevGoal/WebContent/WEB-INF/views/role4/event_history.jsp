	...
	axios({
		  ...
		  url: "eventHistoryData",
			...
			$.each(response.data, function(i, data) {
				    ...
				    newCell2.innerHTML = "<p class='fw-normal mb-1'>"+response.data[i].detail+"</p>"
				    newCell3.innerHTML = "<p class='fw-normal mb-1'>"+response.data[i].ip_address+"</p>"
				    newCell4.innerHTML = "<p class='fw-normal mb-1'>"+response.data[i].time_reg+"</p>"

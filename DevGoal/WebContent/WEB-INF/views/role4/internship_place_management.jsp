	...
	axios({
		  ...
		  url: "findPlaceOfInternship",
			...
			$.each(response.data, function(i, data) {
				    ...
				    newCell5.innerHTML = "<button onClick='manegementStatus("+response.data[i].place_of_insternship_id+", 1)' class='btn btn-success'>ยืนยัน</button><button onClick='manegementStatus("+response.data[i].place_of_insternship_id+", 0)' class='btn btn-danger'>ปฏิเสธ</button>"

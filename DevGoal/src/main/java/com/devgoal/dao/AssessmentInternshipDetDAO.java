...
public class AssessmentInternshipDetDAO implements DAO<AssessmentInternshipDetModel>{
	...
	public ArrayList<HashMap<String, Object>> queryStudentInternshipComplete(String user_id) {
		
		String sql = "SELECT	  \n" +
				"	assessment_internship.assessment_internship_id role1_complete  \n" +
				"		\n" +
				...
				"GROUP BY assessment_internship.student_place_of_internship_id";
		String[] data = {user_id};
	...
	public ArrayList<HashMap<String, Object>> queryStudentInternshipCompleteFilter(String user_id, String term_id) {

...
public class AssessmentInternshipDetDAO implements DAO<AssessmentInternshipDetModel>{
	...
	public HashMap<String, Object> queryStudentInternshipComplete(String user_id) {
		...
		String sql = "SELECT	\n" +
					...
					"WHERE assessment_internship.status = 1 AND result_internship.user_id = ?";
		String[] data = {user_id};
	...
	public HashMap<String, Object> queryStudentInternshiping(String user_id) {
		...
		String sql = "SELECT \n" +
				...
				"WHERE student_place_of_internship.status = 1 AND place_of_internship.user_id = ? AND student_place_of_internship.student_place_of_internship_id NOT IN (SELECT student_place_of_internship_id FROM assessment_internship)";
		String[] data = {user_id};
		
		return db.querySingleWithPrepare(sql, data);
	}
	
	public HashMap<String, Object> queryStudentInternshipCompleteFilter(String user_id, String begin, String end) {
		...
		String sql = "SELECT	 \n" +
				...
				"INNER JOIN result_internship ON result_internship.result_internship_id = assessment_internship.result_internship_id \n" +
				"INNER JOIN user ON user.user_id = result_internship.user_id \n" +
				"WHERE assessment_internship.status = 1 AND result_internship.user_id = ? AND assessment_internship.time_reg BETWEEN ? AND ?";
		String[] data = {user_id, begin, end};
		
		return db.querySingleWithPrepare(sql, data);
	}
	
	public HashMap<String, Object> queryStudentInternshipingFilter(String user_id, String begin, String end) {
		...
		String sql = "SELECT  \n" +
				...
				"FROM student_place_of_internship \n" +
				"INNER JOIN place_of_internship ON place_of_internship.place_of_internship_id = student_place_of_internship.place_of_internship_id \n" +
				"WHERE student_place_of_internship.status = 1 AND place_of_internship.user_id = ? AND student_place_of_internship.student_place_of_internship_id NOT IN (SELECT student_place_of_internship_id FROM assessment_internship) AND student_place_of_internship.time_reg BETWEEN ? AND ?";
		String[] data = {user_id, begin, end};
